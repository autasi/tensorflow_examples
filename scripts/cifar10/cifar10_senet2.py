...
from arch.senet_graph import cifar10_se_resnet_20_wd
...
def main():
    ...
    # create network
    layers, variables = cifar10_se_resnet_20_wd(x, weight_decay = 0.0001)
    ...
    with session.as_default():
        ...
        net_path = os.path.join(cifar10_net_folder, "cifar10_se_resnet20_wd_randtrans.pkl")
