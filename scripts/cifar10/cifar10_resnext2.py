...
def main():
    ...
    # create network
    layers, variables = cifar10_resnext_29_wd(x, weight_decay = 0.0001)
    ...
    n_epochs = 164 # from https://arxiv.org/pdf/1611.05431.pdf
...
#('Epoch: ', 163)
#('Learning rate: ', 0.001)
#('Test accuracy: ', 0.92324221)
#('Train accuracy: ', 0.99838567)
