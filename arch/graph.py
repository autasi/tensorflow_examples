...
def cifar10_resnet_cbn1r3d2_multi(x):
    """Creates residual neural network for CIFAR10. The network uses 1 batch 
        normalized convolutional and 3 residual layers to create the 
        representation part of the network. The output probabilities are 
        generated by one dense layer followed by a softmax function.
    ...
    conv1 = conv2d_bn(x, size=3, n_filters=16,
                      kernel_init=Kumar_initializer_multi(mode="FAN_AVG", C=[1, 2]),
                      name="initial_conv")
    layers.append(("initial_conv", conv1))
    ...
    fc2 = dense(pool1, n_units=10, activation=None,
                kernel_init=Kumar_initializer_multi(activation=None, mode="FAN_IN", C=[2, 1]),
#                kernel_init=Kumar_initializer(activation=None, mode="FAN_IN"),
                name="fc2")
    layers.append(("fc2", fc2))
...
def cifar10_inception_i2d2(x, drop_rate=0.5):
    """Creates residual neural network for CIFAR10. The network uses 1 batch 
        normalized convolutional and 3 residual layers to create the 
        representation part of the network. The output probabilities are 
        generated by one dense layer followed by a softmax function.
    ...
    layers.append(("inception1", inception1))
            
    inception2 = grid_module_v1(
                    inception1,
                    n_filters_1x1 = 64,
                    n_filters_3x3 = 64,
                    n_reduce_3x3 = 32,
    ...
    layers.append(("inception2", inception2))
        
    flat = flatten(inception2, name="flatten")
    layers.append(("flatten", flat))
...
def cifar10_inception_bni2d2(x, drop_rate=0.5):
    """Creates residual neural network for CIFAR10. The network uses 1 batch 
        normalized convolutional and 3 residual layers to create the 
        representation part of the network. The output probabilities are 
        generated by one dense layer followed by a softmax function.
    ...
    inception1 = bn_grid_module_v2(
                    ...
                    is_training = training,
                    mode = "FAN_AVG",
                    name = "bn_inception_grid_1"            
                    )
    layers.append(("inception1", inception1))
            
    inception2 = bn_grid_module_v2(
                    inception1,
                    n_filters_1x1 = 64,
                    n_reduce_3x3 = 32,
                    n_filters_3x3 = 64,
