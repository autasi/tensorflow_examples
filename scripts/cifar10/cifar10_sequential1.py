...
from arch.sequential_graph import cifar10_sequential_cn3d
...
def main():
    ...
    # create network
    layers, variables = cifar10_sequential_cn3d(x)
    ...
    with session.as_default():
        ...
        net_path = os.path.join(cifar10_net_folder, "cifar10_cn3d_expdecay.pkl")
        save_variables(session, net_path)
    session.close()
    session = None
#('Epoch: ', 99)
#('Learning rate: ', 0.001)
#('Test accuracy: ', 0.60654294)
#('Train accuracy: ', 0.62737966)
