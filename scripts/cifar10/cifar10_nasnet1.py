...
from arch.nasnet_graph import cifar10_nasnet
...
def main():
    ...
    # create network
    layers, variables = cifar10_nasnet(x, drop_rate = 0.5)
    ...
    with session.as_default():
        ...
        net_path = os.path.join(cifar10_net_folder, "cifar10_nasnet_expdecay.pkl")
        save_variables(session, net_path)
    session.close()
    session = None
#('Epoch: ', 49)
#('Learning rate: ', 0.0010471285480508996)
#('Test accuracy: ', 0.68730468)
#('Train accuracy: ', 0.7540378)
