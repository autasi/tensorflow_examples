...
from arch.inception_graph import cifar10_inception_v2_wd
...
def main():
    ...
    mean_acc, max_acc, min_acc = eval_net_custom(
            tr_x, tr_y, te_x, te_y,
            net_func = cifar10_inception_v2_wd,
...
#Test accuracy:  0.93291014
#Train accuracy:  0.9999601
#Mean accuracy:  0.93291014    
