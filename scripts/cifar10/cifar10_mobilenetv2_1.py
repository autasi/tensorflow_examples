...
def main():
    ...
    # create network
    layers, variables = cifar10_mobilenet_v2(x, expand_ratio = 4, n_filters = 16, n_repeat = 2)
    ...
    with session.as_default():
        ...
        net_path = os.path.join(cifar10_net_folder, "cifar10_mobilenet_v2_expdecay.pkl")
