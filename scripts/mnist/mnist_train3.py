...
from arch.graph import mnist_sequential_c2dbn1d1
...
def main():
    ...
    # create network
    layers, variables = mnist_sequential_c2dbn1d1(x)
    ...
    with session.as_default():
        ...
        save_variables(session, "/home/ucu/Work/git/mnist/network/mnist_c2dbn1d1_expdecay.pkl")
    session.close()
    session = None
#Epoch:  39
#Learning rate:  0.00027542287033381673
#Test accuracy:  0.992894
