...
from arch.sequential_graph import cifar10_sequential_cbn6d
...
def main():
    ...
    # create network
    layers, variables = cifar10_sequential_cbn6d(x)
    ...
    with session.as_default():
        ...
        net_path = os.path.join(cifar10_net_folder, "cifar10_cbn6d_expdecay.pkl")
        save_variables(session, net_path)
    session.close()
    session = None
#('Epoch: ', 49)
#('Learning rate: ', 0.0010471285480508996)
#('Test accuracy: ', 0.86259764)
#('Train accuracy: ', 0.9990992)
