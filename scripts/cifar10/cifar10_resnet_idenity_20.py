...
from arch.resnet_identity_graph import cifar10_resnet_identity_20
...
def main():
    ...
    mean_acc, max_acc, min_acc = eval_net_basic(
            tr_x, tr_y, te_x, te_y,
            net_func = cifar10_resnet_identity_20)
    print("Mean accuracy: ", mean_acc)
    print("Max accuracy: ", max_acc)
    print("Min accuracy: ", min_acc)
#Epoch:  49
#Learning rate:  0.0010471285480508996
#Test accuracy:  0.8283203
#Train accuracy:  0.999422
#Mean accuracy:  0.8283203    
