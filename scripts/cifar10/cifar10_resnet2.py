...
from arch.resnet_graph import cifar10_resnet_32
...
def main():
    ...
    # create network
    layers, variables = cifar10_resnet_32(x)
    ...
    with session.as_default():
        ...
        net_path = os.path.join(cifar10_net_folder, "cifar10_resnet32_expdecay.pkl")
        save_variables(session, net_path)
    session.close()
    session = None
#('Epoch: ', 49)
#('Learning rate: ', 0.0010471285480508996)
#('Test accuracy: ', 0.83730471)
#('Train accuracy: ', 0.99984056)
