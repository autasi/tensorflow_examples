...
from arch.graph import mnist_resnet_c1r2d2
...
def main():
    ...
    # create network
    layers, variables = mnist_resnet_c1r2d2(x)
    ...
    with session.as_default():
        ...
        save_variables(session, "/home/ucu/Work/git/mnist/network/mnist_resnet_c1r2d2_expdecay.pkl")
    session.close()
    session = None
#Epoch:  39
