...
def main():
    ...
    # create network
    layers, variables = cifar10_sequential_cbn3d(x)
    ...
    with session.as_default():
        ...
        net_path = os.path.join(cifar10_net_folder, "cifar10_cbn3d_expdecay.pkl")
        save_variables(session, net_path)
    session.close()
    session = None
#('Epoch: ', 49)
#('Learning rate: ', 0.0010471285480508996)
#('Test accuracy: ', 0.82626951)
#('Train accuracy: ', 0.93446273)
