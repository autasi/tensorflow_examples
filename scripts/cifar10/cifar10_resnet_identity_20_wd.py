...
from arch.resnet_identity_graph import cifar10_resnet_identity_20_wd
...
def main():
    ...
    mean_acc, max_acc, min_acc = eval_net_custom(
            tr_x, tr_y, te_x, te_y,
            net_func = cifar10_resnet_identity_20_wd,
...
#Train accuracy:  0.99229914
#Mean accuracy:  0.92275393    
