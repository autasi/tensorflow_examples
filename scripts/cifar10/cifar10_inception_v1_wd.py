...
from arch.inception_graph import cifar10_inception_v1_wd
...
def main():
    ...
    mean_acc, max_acc, min_acc = eval_net_custom(
            tr_x, tr_y, te_x, te_y,
            net_func = cifar10_inception_v1_wd,
...
#Test accuracy:  0.8919922
#Train accuracy:  0.99840564
#Mean accuracy:  0.8919922
